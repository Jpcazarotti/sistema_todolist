    ...
    <main class="container mt-5 mb-5">
        ...
        <div class="row">
            ...
            <div class="col-sm-9 mx-auto">
                ...
                <form action="{{ route('planos.update', ['id' => $plano->id]) }}" method="post">
                    @method('put')
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="valor" name='valor' id="valor" class="form-control col-sm-4 valor"
                            value="{{ old('valor', $plano->valor) }}" placeholder="Digite o valor">
                        @error('valor')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="descricao" id="descricao" class="form-control" rows="5">{{ old('descricao', $plano->descricao) }}</textarea>
                        @error('descricao')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
